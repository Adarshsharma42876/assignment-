...
function App() {
  ...
  return (
    <div className="flex justify-center items-center bg-coral 200 min-h-screen">
      {userData ? (
        <div className="flex flex-col lg:flex-row gap-10 justify-between">
          <div>
            <h1 className="text-center mb-2 uppercase  text-red-500 text-xl font-bold">
              Variant 1
            </h1>
            <div className="border-4 border-black p-6 h-40  flex gap-5 overflow-hidden justify-between">
              ...
              <div>
                ...
                <p>
                  Gender: <span className="capitalize">{userData.gender}</span>
                </p>
